...
public void notifySessionCompleted(Long studentId, String tutorName, String subject, Long bookingId) {
    push(studentId,
         "Session Completed",
         "Your " + subject + " session with " + tutorName + " has been marked as completed.",
         NotificationType.BOOKING_COMPLETED, bookingId);
}

/** Student no-show → notify student */
public void notifyNoShowStudent(Long studentId, String subject, Long bookingId) {
    push(studentId,
         "Marked as No-Show",
         "You were marked as a no-show for your " + subject + " session.",
         NotificationType.NO_SHOW_STUDENT, bookingId);
}

/** Tutor no-show → notify student */
public void notifyNoShowTutor(Long studentId, String subject, Long bookingId) {
    push(studentId,
         "Tutor Did Not Attend",
         "Your tutor did not attend the " + subject + " session. We're sorry for the inconvenience.",
         NotificationType.NO_SHOW_TUTOR, bookingId);
}
